...
parser.add_argument('--framework_name', type=str, default='baseline')
...
# load config
CONFIG_PATH = {
    'baseline': 'baseline/configs/baseline_config.yaml',
    'adv_baseline': 'baseline/configs/baseline_config.yaml'
}
